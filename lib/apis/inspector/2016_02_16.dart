...
class InspectorApi {
  ...
  /// by the ARN of the assessment target. If the
  /// [service-linked role](https://docs.aws.amazon.com/inspector/latest/userguide/inspector_slr.html)
  /// isn’t already registered, this action also creates and registers a
  /// service-linked role to grant Amazon Inspector access to AWS Services
  ...
  /// a full report. For more information, see
  ...
  /// information about assessment targets, see
  /// [Amazon Inspector Assessment Targets](https://docs.aws.amazon.com/inspector/latest/userguide/inspector_applications.html).
  ///
  /// [filter]: You can use this parameter to specify a subset of data to be
  /// included in the action's response.
  ...
  ///
  /// [stopAction]: An input option that can be set to either START_EVALUATION
  /// or SKIP_EVALUATION. START_EVALUATION (the default value), stops the AWS
