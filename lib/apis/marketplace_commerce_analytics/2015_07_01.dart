...
class MarketplaceCommerceAnalyticsApi {
  ...
  ///
  /// *    **customer\_subscriber\_annual_subscriptions**
  ///
  ///     From 2014-07-21 to present: Available daily by 24:00 UTC.
  ///
  /// *    **daily\_business\_usage\_by\_instance_type**
  ///
  ...
  ///     From 2015-01-26 to present: Available daily by 24:00 UTC.
  ///
  /// *    **daily\_business\_new_instances**
  ///
  ///     From 2015-01-26 to present: Available daily by 24:00 UTC.
  ///
  ...
  ///     From 2015-01-26 to present: Available daily by 24:00 UTC.
  ///
  /// *    **monthly\_revenue\_billing\_and\_revenue_data**
  ///
  ...
  /// one month prior.
  ///
  /// *    **monthly\_revenue\_annual_subscriptions**
  ///
  ///     From 2015-02 to 2017-06: Available monthly on the 4th day of the month
  ...
  /// disbursed\_amount\_by\_age\_of\_disbursed_funds.
  ///
  ...
  ///     From 2015-01-26 to present: Available every 30 days by 24:00 UTC.
  ///
  /// *    **customer\_profile\_by_industry**
  ///
  ...
  ///
  /// *    **customer\_profile\_by_revenue**
  ///
  ///     From 2015-10-01 to 2017-06-29: Available daily by 24:00 UTC.
  ///
  ///     From 2017-06-30 to present: This data set is no longer available.
  ///
  /// *    **customer\_profile\_by_geography**
  ///
  ///     From 2015-10-01 to 2017-06-29: Available daily by 24:00 UTC.
  ///
  ///     From 2017-06-30 to present: This data set is no longer available.
  ///
  /// *    **sales\_compensation\_billed_revenue**
  ///
  ...
  /// month prior.
  ///
  /// *    **us\_sales\_and\_use\_tax_records**
  ///
  ...
  /// csv file. The data set types customer\_support\_contacts\_data and
  /// test\_customer\_support\_contacts_data both result in a csv file
  /// containing the following fields: Product Id, Product Code, Customer Guid,
  ...
  ///
  /// *   _customer\_support\_contacts_data_ Customer support contact data. The
  ...
  /// parameter.
  /// *   _test\_customer\_support\_contacts\_data_ An example data set
  /// containing static test data in the same format as
  /// customer\_support\_contacts_data
  ///
  /// [fromDate]: The start date from which to retrieve the data set in UTC.
  /// This parameter only affects the customer\_support\_contacts_data data set
  /// type.
  ///
  /// [roleNameArn]: The Amazon Resource Name (ARN) of the Role with an attached
  /// permissions policy to interact with the provided AWS services.
