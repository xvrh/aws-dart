...
class CloudFrontApi {
  ...
  Future<void> createCloudFrontOriginAccessIdentity20181105(
  ...
  Future<void> createPublicKey20181105(PublicKeyConfig publicKeyConfig) async {}
  ...
  Future<void> createStreamingDistribution20181105(
      StreamingDistributionConfig streamingDistributionConfig) async {}

  /// Create a new streaming distribution with tags.
  Future<void> createStreamingDistributionWithTags20181105(
  ...
  Future<void> getCloudFrontOriginAccessIdentity20181105(String id) async {}

  /// Get the configuration information about an origin access identity.
  Future<void> getCloudFrontOriginAccessIdentityConfig20181105(
      String id) async {}

  /// Get the information about a distribution.
  Future<void> getDistribution20181105(String id) async {}

  /// Get the configuration information about a distribution.
  Future<void> getDistributionConfig20181105(String id) async {}

  /// Get the field-level encryption configuration information.
  Future<void> getFieldLevelEncryption20181105(String id) async {}

  /// Get the field-level encryption configuration information.
  Future<void> getFieldLevelEncryptionConfig20181105(String id) async {}

  /// Get the field-level encryption profile information.
  Future<void> getFieldLevelEncryptionProfile20181105(String id) async {}

  /// Get the field-level encryption profile configuration information.
  Future<void> getFieldLevelEncryptionProfileConfig20181105(String id) async {}

  /// Get the information about an invalidation.
  Future<void> getInvalidation20181105(
      {@required String distributionId, @required String id}) async {}

  /// Get the public key information.
  Future<void> getPublicKey20181105(String id) async {}

  /// Return public key configuration informaation
  Future<void> getPublicKeyConfig20181105(String id) async {}

  /// Gets information about a specified RTMP distribution, including the
  /// distribution configuration.
  Future<void> getStreamingDistribution20181105(String id) async {}

  /// Get the configuration information about a streaming distribution.
  Future<void> getStreamingDistributionConfig20181105(String id) async {}

  /// Lists origin access identities.
  Future<void> listCloudFrontOriginAccessIdentities20181105(
      {String marker, String maxItems}) async {}

  /// List distributions.
  Future<void> listDistributions20181105(
      {String marker, String maxItems}) async {}

  /// List the distributions that are associated with a specified AWS WAF web
  /// ACL.
  Future<void> listDistributionsByWebAclId20181105(String webAclId,
      {String marker, String maxItems}) async {}

  /// List all field-level encryption configurations that have been created in
  /// CloudFront for this account.
  Future<void> listFieldLevelEncryptionConfigs20181105(
      {String marker, String maxItems}) async {}

  /// Request a list of field-level encryption profiles that have been created
  /// in CloudFront for this account.
  Future<void> listFieldLevelEncryptionProfiles20181105(
      {String marker, String maxItems}) async {}

  /// Lists invalidation batches.
  Future<void> listInvalidations20181105(String distributionId,
      {String marker, String maxItems}) async {}

  /// List all public keys that have been added to CloudFront for this account.
  Future<void> listPublicKeys20181105({String marker, String maxItems}) async {}

  /// List streaming distributions.
  Future<void> listStreamingDistributions20181105(
      {String marker, String maxItems}) async {}

  /// List tags for a CloudFront resource.
  Future<void> listTagsForResource20181105(String resource) async {}
  ...
  Future<void> updateCloudFrontOriginAccessIdentity20181105(
      {@required
          CloudFrontOriginAccessIdentityConfig
              cloudFrontOriginAccessIdentityConfig,
      @required
  ...
  /// `Status` is `Deployed`.
  Future<void> updateDistribution20181105(
      {@required DistributionConfig distributionConfig,
      @required String id,
      String ifMatch}) async {}

  /// Update a field-level encryption configuration.
  Future<void> updateFieldLevelEncryptionConfig20181105(
      {@required FieldLevelEncryptionConfig fieldLevelEncryptionConfig,
      @required String id,
      String ifMatch}) async {}

  /// Update a field-level encryption profile.
  Future<void> updateFieldLevelEncryptionProfile20181105(
      {@required
  ...
  /// the comment.
  Future<void> updatePublicKey20181105(
      {@required PublicKeyConfig publicKeyConfig,
      @required String id,
      String ifMatch}) async {}

  /// Update a streaming distribution.
  Future<void> updateStreamingDistribution20181105(
