...
class ServiceQuotasApi {
  ...
  Future<void> getAwsDefaultServiceQuota(
  ...
  Future<void> getAssociationForServiceQuotaTemplate() async {}

  /// Retrieves the details for a particular increase request.
  Future<void> getRequestedServiceQuotaChange(String requestId) async {}
  ...
  Future<void> getServiceQuota(
      {@required String serviceCode, @required String quotaCode}) async {}

  /// Returns the details of the service quota increase request in your
  /// template.
  Future<void> getServiceQuotaIncreaseRequestFromTemplate(
      {@required String serviceCode,
      @required String quotaCode,
      @required String awsRegion}) async {}
  ...
  Future<void> listAwsDefaultServiceQuotas(String serviceCode,
      {String nextToken, int maxResults}) async {}

  /// Requests a list of the changes to quotas for a service.
  Future<void> listRequestedServiceQuotaChangeHistory(
      {String serviceCode,
      String status,
      String nextToken,
  ...
  Future<void> listRequestedServiceQuotaChangeHistoryByQuota(
      {@required String serviceCode,
      @required String quotaCode,
      String status,
      String nextToken,
  ...
  Future<void> listServiceQuotaIncreaseRequestsInTemplate(
      {String serviceCode,
      String awsRegion,
      String nextToken,
      int maxResults}) async {}
  ...
  /// the `NextToken` response parameter contains a value to pass the next call
  /// to the same API to request the next part of the list.
  Future<void> listServiceQuotas(String serviceCode,
      {String nextToken, int maxResults}) async {}
  ...
  Future<void> listServices({String nextToken, int maxResults}) async {}
  ...
  /// the template.
  Future<void> putServiceQuotaIncreaseRequestIntoTemplate(
      {@required String quotaCode,
      @required String serviceCode,
  ...
  /// object.
  Future<void> requestServiceQuotaIncrease(
      {@required String serviceCode,
      @required String quotaCode,
      @required double desiredValue}) async {}
}
