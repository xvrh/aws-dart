...
class RekognitionApi {
  ...
  Future<void> createStreamProcessor(
  ...
  Future<void> deleteStreamProcessor(String name) async {}
  ...
  Future<void> describeCollection(String collectionId) async {}
  ...
  Future<void> describeStreamProcessor(String name) async {}
  ...
  Future<void> detectFaces(Image image, {List<String> attributes}) async {}
  ...
  Future<void> detectLabels(Image image,
  ...
  Future<void> detectModerationLabels(Image image,
  ...
  /// Guide.
  Future<void> detectText(Image image) async {}
  ...
  Future<void> getCelebrityInfo(String id) async {}
  ...
  Future<void> getCelebrityRecognition(String jobId,
  ...
  /// Rekognition Developer Guide.
  Future<void> getContentModeration(String jobId,
      {int maxResults, String nextToken, String sortBy}) async {}
  ...
  Future<void> getFaceDetection(String jobId,
  ...
  Future<void> getFaceSearch(String jobId,
      {int maxResults, String nextToken, String sortBy}) async {}
  ...
  Future<void> getLabelDetection(String jobId,
      {int maxResults, String nextToken, String sortBy}) async {}
  ...
  Future<void> getPersonTracking(String jobId,
      {int maxResults, String nextToken, String sortBy}) async {}
  ...
  Future<void> listCollections({String nextToken, int maxResults}) async {}
  ...
  /// action.
  Future<void> listFaces(String collectionId,
      {String nextToken, int maxResults}) async {}

  /// Gets a list of stream processors that you have created with
  /// CreateStreamProcessor.
  Future<void> listStreamProcessors({String nextToken, int maxResults}) async {}
  ...
  Future<void> recognizeCelebrities(Image image) async {}
  ...
  Future<void> searchFacesByImage(
      {@required String collectionId,
      @required Image image,
      int maxFaces,
      double faceMatchThreshold}) async {}
  ...
  /// Rekognition Developer Guide.
  Future<void> startCelebrityRecognition(Video video,
  ...
  /// For more information, see Detecting Unsafe Content in the Amazon
  /// Rekognition Developer Guide.
  Future<void> startContentModeration(Video video,
  ...
  /// Rekognition Developer Guide.
  Future<void> startFaceDetection(Video video,
      {String clientRequestToken,
      NotificationChannel notificationChannel,
  ...
  Future<void> startLabelDetection(Video video,
      {String clientRequestToken,
      double minConfidence,
      NotificationChannel notificationChannel,
      String jobTag}) async {}
  ...
  /// call to `StartPersonTracking`.
  Future<void> startPersonTracking(Video video,
      {String clientRequestToken,
      NotificationChannel notificationChannel,
      String jobTag}) async {}
  ...
  Future<void> startStreamProcessor(String name) async {}

  /// Stops a running stream processor that was created by
  /// CreateStreamProcessor.
  Future<void> stopStreamProcessor(String name) async {}
}
