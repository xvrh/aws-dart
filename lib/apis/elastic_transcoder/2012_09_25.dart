...
class ElasticTranscoderApi {
  ...
  ///
  /// [pipelineId]: The `Id` of the pipeline that you want Elastic Transcoder to
  ...
  /// files.
  ///
  /// [input]: A section of the request body that provides information about the
  /// file that is being transcoded.
  ///
  /// [inputs]: A section of the request body that provides information about
  /// the files that are being transcoded.
  ///
  /// [output]:  A section of the request body that provides information about
  /// the transcoded (target) file. We strongly recommend that you use the
  /// `Outputs` syntax instead of the `Output` syntax.
  ///
  /// [outputs]:  A section of the request body that provides information about
  /// the transcoded (target) files. We recommend that you use the `Outputs`
  /// syntax instead of the `Output` syntax.
  ///
  /// [outputKeyPrefix]: The value, if any, that you want Elastic Transcoder to
  /// prepend to the names of all files that this job creates, including output
  /// files, thumbnails, and playlists.
  ///
  /// [playlists]: If you specify a preset in `PresetId` for which the value of
  ...
  /// Elastic Transcoder job. You specify metadata in `key/value` pairs, and you
  /// can add up to 10 `key/value` pairs per job. Elastic Transcoder does not
  /// guarantee that `key/value` pairs are returned in the same order in which
  /// you specify them.
  Future<CreateJobResponse> createJob(String pipelineId,
      {JobInput input,
  ...
  /// specify.
  ///
  /// [name]: The name of the pipeline. We recommend that the name be unique
  /// within the AWS account, but uniqueness is not enforced.
  ///
  /// Constraints: Maximum 40 characters.
  ///
  /// [inputBucket]: The Amazon S3 bucket in which you saved the media files
  /// that you want to transcode.
  ///
  /// [outputBucket]: The Amazon S3 bucket in which you want Elastic Transcoder
  /// to save the transcoded files. (Use this, or use ContentConfig:Bucket plus
  ...
  ///
  /// [role]: The IAM Amazon Resource Name (ARN) for the role that you want
  /// Elastic Transcoder to use to create the pipeline.
  ///
  /// [awsKmsKeyArn]: The AWS Key Management Service (AWS KMS) key that you want
  /// to use with this pipeline.
  ///
  /// If you use either `s3` or `s3-aws-kms` as your `Encryption:Mode`, you
  /// don't need to provide a key with your job because a default key, known as
  /// an AWS-KMS key, is created for you automatically. You need to provide an
  /// AWS-KMS key only if you want to use a non-default AWS-KMS key, or if you
  /// are using an `Encryption:Mode` of `aes-cbc-pkcs7`, `aes-ctr`, or
  /// `aes-gcm`.
  ///
  /// [notifications]: The Amazon Simple Notification Service (Amazon SNS) topic
  ...
  /// returned when you created the topic.
  ///
  /// [contentConfig]: The optional `ContentConfig` object specifies information
  ...
  /// `WRITE_ACP` permissions for the objects that Elastic Transcoder adds to
  ...
  ///
  /// [thumbnailConfig]: The `ThumbnailConfig` object specifies several values,
  ...
  /// services_.
  ///
  /// [name]: The name of the preset. We recommend that the name be unique
  /// within the AWS account, but uniqueness is not enforced.
  ///
  /// [description]: A description of the preset.
  ///
  /// [container]: The container type for the output file. Valid values include
  /// `flac`, `flv`, `fmp4`, `gif`, `mp3`, `mp4`, `mpg`, `mxf`, `oga`, `ogg`,
  /// `ts`, and `webm`.
  ///
  /// [video]: A section of the request body that specifies the video
  /// parameters.
  ///
  /// [audio]: A section of the request body that specifies the audio
  /// parameters.
  ///
  /// [thumbnails]: A section of the request body that specifies the thumbnail
  /// parameters, if any.
  ...
  ///
  /// [pipelineId]: The ID of the pipeline for which you want to get job
  /// information.
  ///
  /// [ascending]:  To list jobs in chronological order by the date and time
  /// that they were submitted, enter `true`. To list jobs in reverse
  /// chronological order, enter `false`.
  ///
  /// [pageToken]:  When Elastic Transcoder returns more than one page of
  /// results, use `pageToken` in subsequent `GET` requests to get each
  ...
  ///
  /// [ascending]: To list pipelines in chronological order by the date and time
  ...
  ///
  /// [ascending]: To list presets in chronological order by the date and time
  /// that they were created, enter `true`. To list presets in reverse
  /// chronological order, enter `false`.
  ///
  /// [pageToken]: When Elastic Transcoder returns more than one page of
  /// results, use `pageToken` in subsequent `GET` requests to get each
  ...
  ///
  /// [inputBucket]: The Amazon S3 bucket that contains media files to be
  /// transcoded. The action attempts to read from this bucket.
  ///
  /// [outputBucket]: The Amazon S3 bucket that Elastic Transcoder writes
  /// transcoded media files to. The action attempts to read from this bucket.
  ///
  /// [topics]: The ARNs of one or more Amazon Simple Notification Service
  ...
  ///
  /// [inputBucket]: The Amazon S3 bucket in which you saved the media files
  /// that you want to transcode and the graphics that you want to use as
  /// watermarks.
  ///
  /// [role]: The IAM Amazon Resource Name (ARN) for the role that you want
  ...
  /// `aes-gcm`.
  ///
  /// [notifications]: The topic ARN for the Amazon Simple Notification Service
  ...
  /// `ReducedRedundancy`, that you want Elastic Transcoder to assign to the
  /// thumbnails that it stores in your Amazon S3 bucket.
  Future<UpdatePipelineResponse> updatePipeline(String id,
      {String name,
      String inputBucket,
      String role,
      String awsKmsKeyArn,
  ...
  ///
  /// [id]: The identifier of the pipeline for which you want to change
...
class Artwork {
  ...
  /// value that you specified in either `MaxWidth` or `MaxHeight` and matches
  ...
  /// proportions of the input art and the output art are different, the output
...
class AudioParameters {
  ...
  ///
  /// *    `auto`  **channel specified, with any input:** Pass through up to
  ...
  ///
  /// *    `1, 2, or auto`  **channels with no audio input:** Audio omitted from
  /// the output
  ///
  ...
  ///
  /// *    `2 or auto`  **channels with one track with two channels:** One track
  /// with two channels
  ///
  ...
  ///
  /// *    `2 or auto`  **channels with two tracks with one channel each:** Two
  /// tracks with one channel each
  ///
  /// *    `2 or auto`  **channels with one track with two channels:** Two
  /// tracks with one channel each
  ///
  /// *    `2`  **channels with one track with multiple channels:** Two tracks
  ...
  /// creates eight single-channel tracks for your output. All tracks that do
  /// not contain audio data from an input channel are MOS, or Mit Out Sound,
  /// tracks.
  ///
  ...
  ///
  /// *    `auto`  **channels with one track with multiple channels:** Up to
  /// eight tracks with one channel each, plus MOS tracks until there are eight
  /// tracks in all
...
class Captions {
  ...
  /// If `CaptionSources` is empty, Elastic Transcoder omits all sidecar
...
class CreateJobOutput {
  ...
  /// pipeline that is specified by the pipeline ID. If a file with the
  ...
  /// with **00001**) to thumbnail file names. The number indicates where a
  /// given thumbnail appears in the sequence of thumbnails for a transcoded
  /// file.
  ///
  ...
  /// anywhere in the `ThumbnailPattern` object. For example, you can include
  /// them as a file name prefix or as a delimiter between `{resolution}` and
  /// `{count}`.
  ///
  /// *     **`{resolution}` (Optional)**: If you want Elastic Transcoder to
  /// include the resolution in the file name, include `{resolution}` in the
  ...
  /// values: `auto`, `0`, `90`, `180`, `270`. The value `auto` generally works
  /// only if the file that you're transcoding contains rotation metadata.
  final String rotate;
  ...
  /// file. This excerpt, called a clip, can come from the beginning, middle, or
  /// end of the file. The Composition object contains settings for the clips
  /// that make up an output file. For the current release, you can only specify
  /// settings for a single clip per output file. The Composition object cannot
  /// be null.
  ...
  /// channel only), `CEA-708 (EIA-708`, first non-empty channel only), and
  /// `mov-text`
  ///
...
class CreateJobPlaylist {
  ...
  /// character, the section of the name before the last `/` must be identical
  ...
  /// the name of the output file is a concatenation of `OutputKeyPrefix` and
  /// `Outputs:Key`:
  ///
  ...
  /// with a file extension of `.m3u8`, and a series of `.ts` files that include
  /// a five-digit sequential counter beginning with 00000:
  ///
...
class CreatePresetResponse {
  ...
  /// but Elastic Transcoder created the preset, this message explains the
  /// reason the preset settings don't meet the standard. Elastic Transcoder
...
class Encryption {
  ...
  /// files. If you specify `s3-aws-kms` and you don't want to use the default
  /// key, you must add the AWS-KMS key that you want to use to your pipeline.
  ///
...
class HlsContentProtection {
  ...
  /// URL must be an absolute path, and is referenced in the URI attribute of
  /// the EXT-X-KEY metadata tag in the playlist file.
...
class Job {
  ...
  /// Transcoder job. You specify metadata in `key/value` pairs, and you can add
  /// up to 10 `key/value` pairs per job. Elastic Transcoder does not guarantee
...
class JobOutput {
  ...
  /// when you created the preset. You can also use the Elastic Transcoder
  ...
  /// Information about the watermarks that you want Elastic Transcoder to add
  /// to the video during transcoding. You can specify up to four watermarks for
  /// each output. Settings for each watermark must be defined in the preset
  ...
  /// mode to use. If you choose not to use encryption, Elastic Transcoder
...
class Pipeline {
  ...
  ///
  /// *    **Complete** (optional): The Amazon SNS topic that you want to notify
  /// when Elastic Transcoder has finished processing the job.
  ///
  /// *    **Warning** (optional): The Amazon SNS topic that you want to notify
  ...
  /// Transcoder to save transcoded files and playlists. Either you specify both
...
class Preset {
  ...
  /// `flv`, `fmp4`, `gif`, `mp3`, `mp4`, `mpg`, `mxf`, `oga`, `ogg`, `ts`, and
  /// `webm`.
  final String container;
...
class PresetWatermark {
  ...
  /// values that you specified for `MaxWidth` and `MaxHeight`. If the relative
  /// proportions of the watermark and the values of `MaxWidth` and `MaxHeight`
  ...
  /// for `VerticalOffset`:
  ///
  /// *    **Top**: The top edge of the watermark is aligned with the top border
  /// of the video.
  ///
...
class Thumbnails {
  ...
  /// matches or exceeds the other value. Elastic Transcoder centers the image
  /// in thumbnails and then crops in the dimension (if any) that exceeds the
  /// maximum value.
  ///
  ...
  /// settings. If the relative proportions of the input video and thumbnails
  /// are different, the thumbnails will be distorted.
  ///
  ...
  /// thumbnail `MaxWidth` and `MaxHeight` settings, Elastic Transcoder crops
  /// the thumbnails.
  ///
  ...
  /// thumbnail `MaxWidth` and `MaxHeight` without exceeding either value. If
  ...
  /// their dimensions match the values that you specified for at least one of
  /// `MaxWidth` and `MaxHeight` without dropping below either value. If you
  /// specify this option, Elastic Transcoder does not scale thumbnails up.
  final String sizingPolicy;
...
class Timing {
  ...
  /// milliseconds.
  final BigInt submitTimeMillis;

  /// The time the job began transcoding, in epoch milliseconds.
  final BigInt startTimeMillis;

  /// The time the job finished transcoding, in epoch milliseconds.
  final BigInt finishTimeMillis;
...
class VideoParameters {
  ...
  /// `BufferSize`, Elastic Transcoder sets `BufferSize` to 10 times the value
  /// of `MaxBitRate`.
  ///
  ...
  /// about how to render color. `Bt.601` is the standard for standard
  /// definition video, while `Bt.709` is the standard for high definition
  /// video.
  ///
  ...
  /// If your job does not have an `AppliedColorSpaceConversion` in its
  ...
  /// where:
  ///
  /// *    _width in pixels_ and _height in pixels_ represent the Resolution of
  /// the output video.
  ///
  /// *    _maximum recommended decoding speed in Luma samples/second_ is less
  ...
  /// rate of the output video. Valid values include: `10`, `15`, `23.97`, `24`,
  /// `25`, `29.97`, `30`, `60`.
  ...
  ///
  /// *     `_width_ x _height_` : The width and height of the output video in
  /// pixels.
  ///
  ///
  ...
  /// following list (_List - Max width x height value_):
  ///
  ///     *   1 - 25344
  ///
  ///     *   1b - 25344
  ...
  /// value that you specified in either `MaxWidth` or `MaxHeight` and matches
  /// or exceeds the other value. Elastic Transcoder centers the output video
  /// and then crops it in the dimension (if any) that exceeds the maximum
  /// value.
  ///
  ...
  /// that its dimensions match the values that you specified for at least one
  /// of `MaxWidth` and `MaxHeight` without dropping below either value. If you
  /// specify this option, Elastic Transcoder does not scale the video up.
  final String sizingPolicy;
