...
class CloudWatchApi {
  ...
  /// are deleted.
  Future<void> deleteDashboards(List<String> dashboardNames) async {}
  ...
  Future<void> describeAlarmHistory(
      {String alarmName,
  ...
  Future<void> describeAlarmsForMetric(
      {@required String metricName,
      @required String namespace,
      String statistic,
  ...
  /// dimension.
  Future<void> describeAnomalyDetectors(
      {String nextToken,
      int maxResults,
      String namespace,
      String metricName,
  ...
  Future<void> getDashboard(String dashboardName) async {}
  ...
  /// in the _Amazon CloudWatch User Guide_.
  Future<void> getMetricStatistics(
      {@required String namespace,
      @required String metricName,
      List<Dimension> dimensions,
      @required DateTime startTime,
  ...
  Future<void> getMetricWidgetImage(String metricWidget,
